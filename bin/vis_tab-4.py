...
class Vis(QWidget):
    ...
    def __init__(self, nanohub_flag):
        ...
        self.controls1.setLayout(self.glayout)
        ...
        self.glayout.addWidget(self.first_button, 0,0,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.back_button, 0,1,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.forward_button, 0,2,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.last_button, 0,3,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.play_button, 0,4,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.cells_checkbox, 0,5,1,2) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(self.substrates_checkbox, 0,7,1,2) # w, row, column, rowspan, colspan

        self.fix_cmap_checkbox = QCheckBox('fix')
        self.fix_cmap_checkbox.setChecked(False)
        self.fix_cmap_checkbox.clicked.connect(self.fix_cmap_toggle_cb)
        self.fix_cmap_checked_flag = False
        icol = 9
        self.glayout.addWidget(self.fix_cmap_checkbox, 0,icol,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(label, 0,icol,1,1) # w, row, column, rowspan, colspan
        icol += 1
        self.glayout.addWidget(self.cmin, 0,icol,1,1) # w, row, column, rowspan, colspan
        ...
        self.glayout.addWidget(label, 0,icol,1,1) # w, row, column, rowspan, colspan
        icol += 1
        self.glayout.addWidget(self.cmax, 0,icol,1,1) # w, row, column, rowspan, colspan

        icol += 1
        self.glayout.addWidget(self.substrates_combobox, 0,icol,1,2) # w, row, column, rowspan, colspan
        ...
        glayout = QGridLayout()
        self.controls2.setLayout(glayout)
        ...
        glayout.addWidget(self.my_xmin, 0,1,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(label, 0,2,1,1) # w, row, column, rowspan, colspan
        glayout.addWidget(self.my_xmax, 0,3,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(label, 0,4,1,1) # w, row, column, rowspan, colspan
        glayout.addWidget(self.my_ymin, 0,5,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(label, 0,6,1,1) # w, row, column, rowspan, colspan
        glayout.addWidget(self.my_ymax, 0,7,1,1) # w, row, column, rowspan, colspan

        w = QPushButton("Reset")
        w.clicked.connect(self.reset_plot_range)
        glayout.addWidget(w, 0,8,1,1) # w, row, column, rowspan, colspan
    ...
    def fix_cmap_toggle_cb(self,bval):
        self.fix_cmap_checked_flag = bval
