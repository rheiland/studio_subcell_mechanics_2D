...
class Vis(QWidget):
    ...
    def __init__(self, nanohub_flag):
        ...
        glayout = QGridLayout()
        self.controls1.setLayout(glayout)
        ...
        glayout.addWidget(self.first_button, 0,0,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.back_button, 0,1,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.forward_button, 0,2,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.last_button, 0,3,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.play_button, 0,4,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.cells_checkbox, 0,5,1,2) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(self.substrates_checkbox, 0,7,1,2) # w, row, column, rowspan, colspan
        ...
        icol = 9
        glayout.addWidget(self.fix_cmap_checkbox, 0,icol,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(label, 0,icol,1,1) # w, row, column, rowspan, colspan
        icol += 1
        glayout.addWidget(self.cmin, 0,icol,1,1) # w, row, column, rowspan, colspan
        ...
        glayout.addWidget(label, 0,icol,1,1) # w, row, column, rowspan, colspan
        icol += 1
        glayout.addWidget(self.cmax, 0,icol,1,1) # w, row, column, rowspan, colspan

        icol += 1
        glayout.addWidget(self.substrates_combobox, 0,icol,1,2) # w, row, column, rowspan, colspan
        ...
        #-------------------
        # self.substrates_combobox = QComboBox(self)
        # self.substrates_combobox.setGeometry(200, 150, 120, 40)
  
        # self.substrates_combobox.addItem("substrate1")
        # self.substrates_combobox.addItem("substrate2")
        self.substrates_combobox.currentIndexChanged.connect(self.substrates_combobox_changed_cb)
        # controls_hbox.addWidget(self.substrates_combobox)
    ...
    def hide_show_plot_range(self):
        print("vis_tab: hide_show_plot_range()")
